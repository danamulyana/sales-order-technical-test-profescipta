 ...
 *   https://datatables.net/download/#dt/dt-2.1.8/fc-5.0.4/fh-4.0.1/r-3.0.3
 *
 * Included libraries:
 *   DataTables 2.1.8, FixedColumns 5.0.4, FixedHeader 4.0.1, Responsive 3.0.3
 */
...
(function( factory ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		builder: "dt/dt-2.1.8/fc-5.0.4/fh-4.0.1/r-3.0.3",
